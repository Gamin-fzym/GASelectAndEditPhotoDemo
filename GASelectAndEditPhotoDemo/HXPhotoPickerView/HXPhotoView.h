...
//#import "HXProEducationPhotoManager.h"
...
@param mark 标识
*/
typedef void (^HXPhotoViewWillShowSheetBlock)(NSInteger mark);
...
/**  点击添加图片弹出菜单时调用  处理隐藏键盘之类的功能*/
@property (copy, nonatomic) HXPhotoViewWillShowSheetBlock showSheetBlock;
