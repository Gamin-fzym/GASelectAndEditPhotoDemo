...
/**  是否已编辑 */
@property (assign, nonatomic) BOOL haveEdit;
/**  编辑之前的原始图片 */
@property (strong, nonatomic) UIImage * _Nullable editOriginalPhoto;
/**  网络图片的比例合乎需要的比例, 不需要重新上传 */
@property (assign, nonatomic) BOOL networkDontNeedEdit;
